...
* Using GPT-4 to build the basic architecture and using cursor.co  to fill the details can be amazingly great.
...
Amazing! Even support diverse weapon change. (Use GPT-4 + [cursor.co](https://cursor.so/))
